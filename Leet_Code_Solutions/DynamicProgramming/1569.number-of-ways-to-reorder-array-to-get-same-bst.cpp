...
public:
    int numOfWays(vector<int> &nums)
    {
        ...
        // Creation of Pascal's triangle for Computation of C(n, k).
        table.resize(m + 1);
...
private:
    ...
    // dfs(nums) -> the number of valid permutations that have the same structure as the Original BST for nums.
